...
# (str) Package name
#package.name = com.mp4recorderapp.mp4recorder
package.name = mp4recorderapp

# (str) Package domain (needed for android/ios packaging)
#package.domain = com.mp4recorderapp
package.domain = mp4recorderapp
...
icon.filename = %(source.dir)s/Mp4Recorder.png
